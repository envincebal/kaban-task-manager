    ...
    <div className={`${sideBarModal && "mobile-show-sidebar"}  sidebar-wrapper`}>
      <div className={`${sidebarToggle && "hide-sidebar"} sidebar`}>
        ...
        <div className="color-theme-div">
              <svg width="19" height="19" xmlns="http://www.w3.org/2000/svg"><path
          ...
          <label className="switch">
            ...
            checked={theme ? false : true} type="checkbox" />
     ...
     <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path
        ...
        <button className={`${sidebarToggle && "hidden-toggle-btn"} sidebar-toggle-btn`} onClick={() => setSidebarToggle(prev => !prev)}>
          {sidebarToggle ? (
            ...
            <>
              <svg width="18" height="16" xmlns="http://www.w3.org/2000/svg"><path
